...
function Header() {
    ...
    return(
        <div className=" absolute mt-5 flex w-full flex-wrap items-center justify-between gap-2 px-5 text-xs 
        font-medium uppercase opacity-90 md:px-10">
            <Head>
                <title>NextJS Slider</title>
            </Head>
            ...
            <ul className="flex flex-wrap items-center gap-3 text-[11px] md:gap-10">
                {menus.map((menu, index) => {
                    return (
                        ...
                        } inline-block cursor-pointer border-b-yellow-500 transition duration-300 ease-in-out
